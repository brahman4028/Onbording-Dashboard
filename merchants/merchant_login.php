						...
						<div class="card-body p-sm-5">
							<div class="">
								...
								<div class="text-center mb-4">
									<h5 class="">Merchant Login</h5>
									<p class="mb-0">Please log in to your account</p>
								</div>
								<div class="form-body">
									<form class="row g-3" action="loginprocess.php" method="POST">
										<div class="col-12">
											<label for="inputEmailAddress" class="form-label">Email or Number</label>
											<input type="text" class="form-control" name="emailorphone" id="inputEmailAddress" placeholder="jhon@example.com or 9876543210" required>
										</div>
										...
										<div class="col-12">
											<div class="text-center">
												<p class="mb-0">Don't have an account yet? <a href="merchant_register.php">Sign up here</a></p>
											</div>
										</div>
									</form>
								</div>
