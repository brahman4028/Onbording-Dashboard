...
$merQuery = "SELECT application_id FROM merchant_info where email = '$merchantuseremail' LIMIT 1"; 
...
$merchantusername = $merData['application_id'];;
echo $application_id;
...
<body>
    <div class="wrapper" style="display: flex; flex-direction:column; height:100vh; ">
        ...
        <form action="action.php" method="POST" enctype="multipart/form-data" id="myForm">
            ...
            <input type="hidden" name="merchantname" value="<?php echo "$merchantusername" ?>">
            <!-- ///////// -->
